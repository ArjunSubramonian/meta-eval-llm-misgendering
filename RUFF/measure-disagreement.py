...
plt.tight_layout()
plt.savefig('plots/RUFF-beta.pdf')
...
plt.tight_layout()
plt.savefig('plots/RUFF-pre-agreement.pdf')
...
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig('plots/RUFF-post-agreement.pdf')
...
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig('plots/RUFF-pre-gen-variation.pdf')
...
plt.legend(loc='lower left')
plt.tight_layout()
plt.savefig('plots/RUFF-post-gen-variation.pdf')